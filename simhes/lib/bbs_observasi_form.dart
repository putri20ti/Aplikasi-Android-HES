...
class _ObservasiFormState extends State<ObservasiForm> {
  ...
  Future<void> _fetchKaryawanData() async {
    var url = kIsWeb
        ? Uri.parse('http://localhost/Flutter/flutterapi/get_karyawan.php')
        : Uri.parse('http://192.168.1.22/flutterapi/get_karyawan.php');
    try {
  ...
  void _saveObservasi() async {
    ...
    final url = kIsWeb
        ? Uri.parse('http://localhost/Flutter/flutterapi/observasi.php')
        : Uri.parse('http://192.168.1.22/flutterapi/observasi.php');
